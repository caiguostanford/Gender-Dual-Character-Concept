...
lm_rel = lmer(value~relevel(Type, ref="DualCharacter")*Statement+(1+Statement|Concept)+(1+Type*Statement|index), control = lmerControl(optCtrl = list(maxfun=100000)), dv)
summary(lm_rel)

lm_wrel = lmer(value~relevel(Type, ref="Woman")*Statement+(1+Statement|Concept)+(1+Type*Statement|index), control = lmerControl(optCtrl = list(maxfun=100000)), dv)
summary(lm_wrel)
```
